    ...
    <div class="box">
        <div class="nav">
            <ul class="location">
                ...
                <Dropdown  placement="bottom-start">
                    <a href="javascript:void(0)">
                        ...
                        <i class="icon iconfont icon-gps"></i>{{city}}
                    </a>
            ...
            <ul class="detail">
                ...
                你好，请<router-link to="/login">登录 <i class="iconfont icon-role"></i></router-link> |<span class="text-color-red"><router-link to="/SignUp">免费注册 <i class="iconfont icon-lijizhuce"></i></router-link></span>
                </li>
